...
export const HomeScreen = ({ navigation }: any) => {
  ...
  return (
    <ImageBackground source={require('../../assets/images/home/img_landing_background.png')} style={pBackgroundImageStyles.fullBg}>
      <SafeAreaView style={styles.containter}>
        <View>
          <Pressable style={styles.setting}>
            <Image source={require('../../assets/images/icons/icon_settings.png')}></Image>
          </Pressable>
          <View>
            <Text style={pColorStyles.grey}>Welcome back to</Text>
            <Pressable style={styles.projectBox}>
              <Text style={[pFontStyles.weightBold, styles.project]}>J3668-Development Project </Text>
              <Image source={require('../../assets/images/icons/icon_drop_down.png')}></Image>
            </Pressable>
          </View>
        </View>
        <View>
